...
*/
(function(f, define){
    define([ "./kendo.data", "./kendo.draganddrop", "./kendo.userevents", "./kendo.mobile.scroller", "./kendo.drawing", "./kendo.core", "./kendo.dataviz.core", "./kendo.popup", "./kendo.toolbar", "./kendo.editable", "./kendo.window", "./kendo.dropdownlist", "./kendo.dataviz.themes" ], f);
})(function(){
